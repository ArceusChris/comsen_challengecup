...
"""
图像采集脚本
从/standard_vtol_0/camera/image_raw话题获取图像，以6fps频率保存到dataset文件夹

用法:
    python image_capture.py

功能:
    - 订阅/standard_vtol_0/camera/image_raw话题
...
class ImageCapture:
    def __init__(self, output_dir="dataset", capture_fps=6.0):
        ...
        print(f"  - Topic: /standard_vtol_0/camera/image_raw")
    ...
    def run(self):
        ...
        try:
            ...
            rospy.wait_for_message('/standard_vtol_0/camera/image_raw', Image, timeout=10.0)
